...
public partial class NcrPurchasing
{
    ...
    [Column("ncrPurchasingLastUpdate", TypeName = "datetime")]
    public DateTime NcrPurchasingLastUpdate { get; set; }
    ...
    [InverseProperty("NcrPurchasings")]
    public virtual OpDispositionType OpDispositionType { get; set; } = null!;
}
